...
def get_config_classification(model_name, dataset_name, config_file=""):
    """
    Get the classification config of given dataset and model from config file.
    ...
    if dataset_name not in config_all[model_name]['datasetParams']:
        raise ValueError(f"Dataset '{dataset_name}' not found for model '{model_name}'")
