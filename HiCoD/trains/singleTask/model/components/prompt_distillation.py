...
class HierarchicalConsistencyGuidedPromptDistillation(nn.Module):
    """
    完整的Hierarchical Consistency-Guided Prompt Distillation模块
    """
    ...
    def forward(self, modal_features: Dict[str, torch.Tensor],
        ...
        Returns:
            losses: 包含所有损失的字典
        """
        # 1. Local-Level Distillation: L_distill^local
        local_loss = self.local_distillation(modal_features, local_anchors)
        
        # 2. Fusion-Level Distillation: L_distill^global
