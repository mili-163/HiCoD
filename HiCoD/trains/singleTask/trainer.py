...
class HiCoDTrainer:
    ...
    def __init__(self, args):
        ...
        self.output_dir = f"results/hicod_{getattr(args, 'dataset_name', 'mosi')}"
    ...
    def do_validate(self, model, dataloader: DataLoader, mode: str = "VALIDATION") -> Dict[str, float]:
        """Validate the model"""
        self.model = model.to(self.device)
        results = self.validate_epoch(dataloader)
